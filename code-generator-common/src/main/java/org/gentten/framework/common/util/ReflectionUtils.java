...
public class ReflectionUtils {
     ...
     * @return 字段列表
     */
    public static <T extends BaseEntity> List<Field> getEntityFields(T entity) {
        List<Field> fieldList = new ArrayList<>();
        for (Class<?> superClass = entity.getClass();
             superClass != Model.class; superClass = superClass.getSuperclass()) {
    ...
    public static Object invokeGetterMethod(Object obj, String propertyName) {
        String getterMethodName = "getProperty" + StringUtils.capitalize(propertyName);
    ...
    /**
     * getDeclareMethod 只能获取当前类中声明的方法。
     * <p>
     * 循环向上获取对象的DeclaredMethod直到找到对应方法,并强制设置为可访问.
     * 如向上转型到Object仍无法找到, 返回null.
     * <p>
     ...
     * eg.
     * public UserDao extends HibernateDao<product>
     *
     ...
     * 如无法找到, 返回Object.class.
     * <p>
     * 如public UserDao extends HibernateDao<product,Long>
     *
