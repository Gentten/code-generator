...
public class CodeModuleQuery extends BaseQuery<CodeModule> {
    /**
    ...
    @Override
    public QueryWrapper<CodeModule> buildWrapper() {
        QueryWrapper<CodeModule> queryWrapper = new QueryWrapper<>();
        //查询条件
        if (search != null) {
